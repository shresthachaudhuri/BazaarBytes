    ...
    def default_knowledge_base(self) -> dict:
        return {
            "greetings": {
                ...
                "responses": ["Hello! I'm Friday..... How can I assist you today with your cultural shopping needs?",
            ...
            "farewells": {
                ...
                "responses": ["Goodbye! Have a culturally enriching day!",
            ...
            "product_inquiries": {
                ...
                "responses": ["We offer a wide range of cultural products including traditional art, handicrafts, music, books, clothing, and more from various cultures around the world.",
            ...
            "order_status": {
                ...
                "responses": ["To track your order, please provide your order number. I'll check the status for you.",
            ...
            "payment_issues": {
                ...
                "responses": ["I'm sorry to hear about the payment issue. Could you tell me which payment method you're using?",
            ...
            "returns_refunds": {
                ...
                "responses": ["Our return policy allows returns within 30 days of purchase. Please provide your order number for assistance.",
            ...
            "account_help": {
                ...
                "responses": ["If you forgot your password, use the 'Forgot Password' link on the login page to reset it.",
            ...
            "shipping": {
                ...
                "responses": ["Shipping costs vary based on location and order size. Check at checkout for exact rates.",
            ...
            "promotions": {
                ...
                "responses": ["Check our website for current promotions and discounts on cultural products!",
            ...
            "feedback": {
                ...
                "responses": ["We value your feedback! Please share your thoughts on our service or products.",
            ...
            "default": {
                ...
                "responses": ["How can I assist you today? Whether it's products, orders, or accounts, I'm here to help!",
...
class Chatbot:
    ...
    # ——— Replace your old save_session with this ———
    def save_session(self, user_id: str, session_data: dict):
        # 1. Compute the sessions directory
        base_dir = os.path.dirname(__file__)
        sessions_dir = os.path.join(base_dir, "sessions")

        # 2. Log what paths we’re using
        logger.debug(f"__file__           = {__file__}")
        logger.debug(f"base_dir           = {base_dir}")
        logger.debug(f"sessions_dir       = {sessions_dir}")
        logger.debug(f"will write to file = {os.path.join(sessions_dir, f'session_{user_id}.json')}")
